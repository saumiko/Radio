...
public class StreamEncoderPCMImpl extends StreamEncoderImpl
{
    ...
    /** Creates a new instance of StreamEncoderPCMImpl */
    public StreamEncoderPCMImpl(String sourceFile,LAMEOnJStdEncoderImpl std)
    {
        super(sourceFile,std);               
    }
    
    public StreamEncoderPCMImpl(InputStream input,LAMEOnJStdEncoderImpl std)
    {    
        super(input,std);         
    }
